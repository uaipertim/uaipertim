  ...
  async saveEstablishment(est: Establishment): Promise<void> {
    ...
    try {
      ...
      const firestoreData = {
        ...
        description: est.aboutDescription !== undefined ? est.aboutDescription : (est.description || null),
        aboutDescription: est.aboutDescription !== undefined ? est.aboutDescription : null,
        acceptsDelivery: est.acceptsDelivery !== undefined ? est.acceptsDelivery : (est.entregaPropria !== undefined ? est.entregaPropria : true),
        acceptsPickup: est.acceptsPickup !== undefined ? est.acceptsPickup : (est.atendeRetirada !== undefined ? est.atendeRetirada : true),
        acceptedPaymentMethods: est.acceptedPaymentMethods || null,
        ...
        pausedUntil: (est as any).pausedUntil || null,
        ...
        baseEstimatedMinutes: (est.baseEstimatedMinutes !== undefined && est.baseEstimatedMinutes !== null) ? Number(est.baseEstimatedMinutes) : null,
        deliveryTimeMin: (est.baseEstimatedMinutes !== undefined && est.baseEstimatedMinutes !== null) ? Number(est.baseEstimatedMinutes) : ((est as any).deliveryTimeMin !== undefined ? Number((est as any).deliveryTimeMin) : 30),
        deliveryTimeMax: (est.baseEstimatedMinutes !== undefined && est.baseEstimatedMinutes !== null) ? Number(est.baseEstimatedMinutes) + 15 : ((est as any).deliveryTimeMax !== undefined ? Number((est as any).deliveryTimeMax) : 45),
        deliveryTime: est.deliveryTime || ((est.baseEstimatedMinutes !== undefined && est.baseEstimatedMinutes !== null) ? `${est.baseEstimatedMinutes}-${Number(est.baseEstimatedMinutes) + 15} min` : '30-45 min'),
        fulfillment: {
